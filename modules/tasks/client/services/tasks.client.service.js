...
angular.module('core').factory('Task', ['$resource', function ($resource) {
  return $resource(appslugAdmin + '/' + 'api/tasks/create', {}, {
    create: { method: 'POST', isArray: false, cache: false },
    get: {
    ...
    delete: {
      ...
      params: {
        taskId: '@taskId'
      }, method: 'DELETE', isArray: false, cache: false
    },
    search: {
      url: appslugAdmin + '/api/tasks/search',
      method: 'POST', isArray: false, cache: false
    },
    changeStatus: {
      ...
      method: 'PUT', isArray: false, cache: false
    },
  });
}]);
