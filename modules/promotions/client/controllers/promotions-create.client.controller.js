...
angular.module('promotions.admin').controller('PromotionCreateController',
  ['$scope', '$state', 'ToastMessage', 'Promotion', 'CustomerGroup', 'Location',
    function ($scope, $state, ToastMessage, Promotion, CustomerGroup, Location) {
      ...
      $scope.elem = {
        ...
        action: {
          ...
          create: function (form) {
            ...
            promotion = PromotionUtil.mappingServer(promotion);
            Promotion.create(promotion, function () {
        ...
        load_data: {
          ...
          config: function () {
            ...
            $scope.changeVariantPromotionType = function (variant) {
